...
<body>
	...
	<div class="myPage-box">
		<div class="info-zone">
			<img src="/resources/images/${loginUser.mbPhoto}.png"
			...
			<div class="btn-zone">
				<input type="button" value="내 정보 수정" class="myPage-btn"
					onclick="location.href='/member/myInfo'"> &nbsp;&nbsp; <input
					type="button" value="결제 관리" class="myPage-btn"
					onclick="location.href='/member/purchaseView'">
			</div>
		</div>
		<div class="box-zone">
			<div class="my-study">
				...
				<div class="study-zone">
					<c:if test="${!empty myStudyList}">
						<c:forEach var="study" items="${myStudyList}" varStatus="i">
							<div class="study-box"
								onclick="location.href='/study/${study.url}'">
								<div class='txt-box'>
