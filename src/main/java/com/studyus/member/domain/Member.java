...
public class Member {
	...
	public Member(int mbNo, String mbId, String mbPassword, String mbEmail, char mbPhone, int mbReputation, int mbPhoto,
			int mbStatus) {
		super();
		this.mbNo = mbNo;
		this.mbId = mbId;
	...
	public String toString() {
		return "Member [mbNo=" + mbNo + ", mbId=" + mbId + ", mbPassword=" + mbPassword + ", mbEmail=" + mbEmail
				+ ", mbPhone=" + mbPhone + ", mbReputation=" + mbReputation + ", mbPhoto=" + mbPhoto + ", mbStatus="
				+ mbStatus + "]";
	}
